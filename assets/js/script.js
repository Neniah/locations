$(function(){
  ...
  var saveContainer = $('.save-container'),
      ...
      favoriteLocationListGroup = $('.list-group');
  ...
  // Form submit and Search icon handler
  ...
  if(hasFavoriteLocations) {
    ...
    array.forEach(function(item){
      favoriteLocationsListGroup.append('<a class="list-group-item" data-lat=""' + item.lat + '" data-lng="' +
      item.lng + '" data-createdAt="' + item.createdAt + '">' + item.address + '<span class="createdAt">' +
      moment(item.createdAt).fromNow() + '</span><span class="glyphicon glyphicon-menu-right"></span></a>');
    });
  ...
  function showLocationByAddress(e){
    ...
    GMaps.geocode({
      ...
      callback: function(results, status){
        ...
        // Adding a market on the wanted location
        ...
        if(!isLocationFavorite){
          ...
          favoriteLocationListGroup.find('a.list-group-item[data-lat="]' + latlng.lat() + '"][data-lng="' + latlng.lng() + '"]').addClass('active-location');
        }
  ...
  function showLocationByCoordinates(e){
    ...
    GMaps.geocode({
      ...
      callback: function(results, status){
        ...
        // Adding colores background to the active favorite location
        ...
        // Add the favorite incon on the given location
        favoriteIcon.removeClass('glyphicon-star-empty').addClass('glyphicon-star');
